...
# ==============================================================================
# 2. CARGAR EL ENSAMBLE (Original + Ligero)
# ==============================================================================
MODEL_DIR = "modelos_descargados_ensamble_2"
os.makedirs(MODEL_DIR, exist_ok=True)

# --------------------------------------------------------------------------
# ¡¡ACCIÓN REQUERIDA!!
# 1. Confirma la URL del modelo original.
# 2. Ve a tu página de GitHub Releases y copia la URL del modelo de 59MB.
# Pégalas aquí:
# --------------------------------------------------------------------------
MODEL_URLS = [
...
# --- Carga de Modelos ---
descargar_modelos()
print("Cargando modelos del ensamble (Original + Ligero)...")
...
def predict_endpoint():
    # ... (El resto de esta función es idéntica, no necesita cambios) ...
